//
//  VLCFLMLToSystemBalanceEquationsVendor.m
//  Hybrid
//
...
#import "VLCFLMLToSystemBalanceEquationsVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLCFLMLToSystemBalanceEquationsVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    // Setup blocks -
    // Input handler block -
    __weak VLCFLMLToSystemBalanceEquationsVendor *weak_self = self;
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateSystemBalancesWithOptions:options];
