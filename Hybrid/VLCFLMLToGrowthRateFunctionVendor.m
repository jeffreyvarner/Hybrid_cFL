//
//  VLCFLMLToGrowthRateFunctionVendor.m
//  Hybrid
//
//  Created by Jeffrey Varner on 8/30/13.
//  Copyright (c) 2013 Varnerlab. All rights reserved.
//

#import "VLCFLMLToGrowthRateFunctionVendor.h"
#import "VLAbstractLanguageAdaptor.h"

@implementation VLCFLMLToGrowthRateFunctionVendor
...
-(void)startTransformationWithName:(NSString *)transformationName
{
    ...
    // Setup blocks -
    // Input handler block -
    __weak VLCFLMLToGrowthRateFunctionVendor *weak_self = self;
    void (^VLOperationBlock)(void) = ^{
        ...
        NSString *code_block = [[self myLanguageAdaptor] generateGrowthRateFunctionBufferWithOptions:options];
